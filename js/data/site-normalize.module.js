...
export function installSiteNormalize() {
  if (typeof window.normalizeSitesForState === "function" && typeof window.ensureSiteIds === "function") {
    return {
      makeSiteId: window.makeSiteId,
      ensureSiteIds: window.ensureSiteIds,
      normalizeSitesForState: window.normalizeSitesForState,
    };
  }
  ...
  return { makeSiteId, ensureSiteIds, normalizeSitesForState };
}

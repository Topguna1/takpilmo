...
function getCategoryNameSafe(key) {
  if (typeof window.getCategoryName === "function") return window.getCategoryName(key);
  const cats = window.defaultCategories || {};
...
export function installSearchEngine() {
  ...
  if (
    typeof window.App.search.getFilteredSites === "function" &&
    typeof window.App.search.initFuse === "function"
  ) {
    return window.App.search;
  }

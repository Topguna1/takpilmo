...
function installDomHighlighter() {
  const HL_TAG = "span";
...
export function installHighlight() {
  if (typeof window.highlightSearchTerms === "function" && window.ddakHighlight) {
    return {
      highlightSearchTerms: window.highlightSearchTerms,
      makeSearchSnippet: window.makeSearchSnippet,
      ddakHighlight: window.ddakHighlight,
    };
  }
  ...
  installDomHighlighter();
  return { highlightSearchTerms, makeSearchSnippet, ddakHighlight: window.ddakHighlight };
}

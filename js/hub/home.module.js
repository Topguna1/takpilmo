  ...
  return `<div class="home home-rich">
    ...
    <section class="home-start" aria-labelledby="startTitle"><div class="section-intro"><div><p class="eyebrow">나에게 맞는 시작</p><h2 id="startTitle">오늘은 무엇을 찾고 있나요?</h2></div><p>목적에 따라 두 가지 방법으로 시작해 보세요.</p></div>
      <div class="entry-grid">
        ...
        <a class="entry entry-guide" href="#/info"><div class="entry-heading"><span class="entry-icon">${icon('compass')}</span><span class="entry-number">02 / GUIDE</span></div><h2>딱필 정보</h2><p>짧게 읽고, 하나 더 알아가는 시간.<br>공부에 필요한 지식과 사이트 활용 이야기를 만나보세요.</p><div class="entry-tags"><span>학습 정보</span><span>사이트 활용</span></div><strong>딱필 정보 읽어보기 ${icon('arrow')}</strong></a>
      </div>
    </section>

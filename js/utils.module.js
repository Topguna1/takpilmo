...
export function installUtils() {
  if (typeof window.escapeHtml === "function" && typeof window.debounce === "function") {
    return {
      escapeHtml: window.escapeHtml,
      debounce: window.debounce,
      getChosung: window.getChosung,
      getChosungSafe: window.getChosungSafe,
    };
  }
  ...
  window.getChosungSafe = getChosungSafe;
  ...
  return { escapeHtml, debounce, getChosung, getChosungSafe };
}
